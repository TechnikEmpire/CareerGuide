...
export const uiTextRu = {
  ...
  sidebar: {
    profileLabel: "Имя профиля",
    profilePlaceholder: "Мой профиль",
    useProfile: "Сохранить имя",
    profileCodeLabel: "Код профиля",
    copyProfileCode: "Скопировать код",
    importProfileCode: "Импорт кода профиля",
    importProfilePlaceholder: "cg-...",
    importProfile: "Импорт",
    profileCodeCopied: "Код профиля скопирован.",
    profileImported: "Код профиля импортирован.",
    profileSaved: "Имя профиля сохранено.",
    profileImportInvalid: "Введите корректный код профиля до 64 символов.",
  ...
  workspace: {
    ...
    historyKicker: "История диалогов",
  ...
  plan: {
    ...
    calendarStudy: "Учёба",
    calendarBreak: "Перерыв",
    calendarAgenda: "Повестка",
    calendarSelectedEvent: "Выбранная сессия",
    calendarNoEvents: "В этом месяце нет запланированных сессий.",
    calendarNoEventSelected: "Выберите событие в календаре, чтобы посмотреть сессию.",
    deleteSession: "Удалить сессию",
    confirmDeleteSession: "Удалить эту календарную сессию из сохранённого плана?",
    confirmClearPlan: "Очистить сохранённый план для этого профиля?",
  ...
  message: {
    ...
    planUpdateSuggested: "Предложено обновление плана",
    applyPlanUpdate: "Применить обновлённый план",
  },
  citation: {
    sources: "Источники",
