...
Этот рабочий процесс выполняется **до** пайплайна разработки приложения. На этом этапе цель еще не состоит
...
Текущий сырой источник данных - это документ на английском языке в формате CSV classification dump:
