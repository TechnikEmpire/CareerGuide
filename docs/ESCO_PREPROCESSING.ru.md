# Подготовка и переводы данных Европейских навыков, компетенций, квалификаций и профессий
...
Инструменты предварительной обработки записывают данные в:
